...
const BottomNavbar = () => {
  ...
  return (
    <nav
      className={`fixed bottom-0 h-16 bg-[#F5F5F5] md:hidden transition ${
        isMain ? "translate-y-0" : "translate-y-24"
      }`}
    >
      <ul className="flex w-screen list-none flex-row items-end justify-between px-6 sm:px-12">
        <li>
          <a
          ...
          >
            <MoreIcon />
            <span className="whitespace-nowrap text-center font-yekan text-sm font-bold text-blue-zodiac">
              بیشتر
            </span>
          </a>
        </li>
        ...
        <li>
          ...
          >
            <HomeIcon />
            <span className="whitespace-nowrap text-center font-yekan text-sm font-bold text-spring-green">
              خانه
            </span>
          </a>
        </li>
